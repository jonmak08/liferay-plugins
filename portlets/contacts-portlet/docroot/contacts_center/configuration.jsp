...
<aui:form action="<%= configurationActionURL %>" method="post" name="fm">
	...
	<liferay-ui:panel-container extended="<%= true %>" id="documentLibrarySettingsPanelContainer" persistState="<%= true %>">
		...
		<liferay-ui:panel collapsible="<%= true %>" extended="<%= true %>" id="documentLibraryDisplay" persistState="<%= true %>" title="display-settings">
			...
			<aui:input name="preferences--showSMS--" type="checkbox" value="<%= showSMS %>" />

			<aui:input name="preferences--showSocialNetwork--" type="checkbox" value="<%= showSocialNetwork %>" />

			<aui:input name="preferences--showIcon--" type="checkbox" value="<%= showIcon %>" />

			<aui:input name="preferences--showRecentActivity--" type="checkbox" value="<%= showRecentActivity %>" />

			<aui:input name="preferences--showSites--" type="checkbox" value="<%= showSites %>" />

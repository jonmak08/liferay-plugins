<div class="carousel slide" data-ride="carousel" id="carousel-dynamic">
	...
	<#else>
		...
		<div class="carousel-inner" role="listbox">
			<div class="active item">
				<img alt="Slide 1" src="http://www.template-joomspirit.com/theme-wordpress/theme-01/wp-content/uploads/2014/10/50-1100x418.jpg">
			</div>
			<div class="item">
				<img alt="Slide 2" src="http://www.template-joomspirit.com/theme-wordpress/theme-01/wp-content/uploads/2014/10/20-1100x418.jpg">
			</div>
			<div class="item">
				<img alt="Slide 3" src="http://www.template-joomspirit.com/theme-wordpress/theme-01/wp-content/uploads/2014/10/70-1100x418.jpg">
			</div>
			<div class="item">
				<img alt="Slide 4" src="http://www.template-joomspirit.com/theme-wordpress/theme-01/wp-content/uploads/2014/10/40-1100x418.jpg">
			</div>
		</div>
	</#if>

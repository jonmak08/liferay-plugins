<div class="columns-1-4-2" id="main-content" role="main">
	...
	<div class="portlet-layout row-fluid no-gutter">
		...
		<div class="portlet-column span3 portlet-column-last span3" id="column-5">
	...
	<div class="portlet-layout row-fluid no-gutter">
		...
		<div class="portlet-column portlet-column-last span9" id="column-7">
